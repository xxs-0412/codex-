...
CANDIDATES = [
    ("R2_Run16_Run28_Run8_Run11", ["Run16.csv", "Run28.csv", "Run8.csv", "Run11.csv"]),
    ("R2_Run15_Run28_Run8_Run11", ["Run15.csv", "Run28.csv", "Run8.csv", "Run11.csv"]),
    ("R2_Run4_Run28_Run24_Run11", ["Run4.csv", "Run28.csv", "Run24.csv", "Run11.csv"]),
    ("R2_Run4_Run28_Run25_Run11", ["Run4.csv", "Run28.csv", "Run25.csv", "Run11.csv"]),
    ("R2_Run4_Run28_Run7_Run11", ["Run4.csv", "Run28.csv", "Run7.csv", "Run11.csv"]),
    ("R2_Run4_Run28_Run8_Run12", ["Run4.csv", "Run28.csv", "Run8.csv", "Run12.csv"]),
    ("R2_Run4_Run28_Run8_Run29", ["Run4.csv", "Run28.csv", "Run8.csv", "Run29.csv"]),
    ("R2_Run16_Run28_Run24_Run11", ["Run16.csv", "Run28.csv", "Run24.csv", "Run11.csv"]),
    ("R2_Run16_Run28_Run25_Run29", ["Run16.csv", "Run28.csv", "Run25.csv", "Run29.csv"]),
    ("R2_Run15_Run28_Run24_Run29", ["Run15.csv", "Run28.csv", "Run24.csv", "Run29.csv"]),
    ("R2_Run16_Run30_Run24_Run29", ["Run16.csv", "Run30.csv", "Run24.csv", "Run29.csv"]),
    ("R2_Run15_Run20_Run24_Run29", ["Run15.csv", "Run20.csv", "Run24.csv", "Run29.csv"]),
]
DETAIL_PATH = RESULT_DIR / "筛查明细_round2_各候选各模型.csv"
SUMMARY_PATH = RESULT_DIR / "筛查汇总_round2_候选split.csv"
HIT_PATH = RESULT_DIR / "命中候选_round2_Transformer增强第一.csv"
