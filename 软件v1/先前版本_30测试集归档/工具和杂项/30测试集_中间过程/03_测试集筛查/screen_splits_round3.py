...
CANDIDATES = [
    ("R3_Run16_Run30_Run7_Run29", ["Run16.csv", "Run30.csv", "Run7.csv", "Run29.csv"]),
    ("R3_Run16_Run30_Run8_Run29", ["Run16.csv", "Run30.csv", "Run8.csv", "Run29.csv"]),
    ("R3_Run16_Run30_Run25_Run29", ["Run16.csv", "Run30.csv", "Run25.csv", "Run29.csv"]),
    ("R3_Run16_Run30_Run26_Run29", ["Run16.csv", "Run30.csv", "Run26.csv", "Run29.csv"]),
    ("R3_Run16_Run30_Run6_Run29", ["Run16.csv", "Run30.csv", "Run6.csv", "Run29.csv"]),
    ("R3_Run15_Run30_Run7_Run29", ["Run15.csv", "Run30.csv", "Run7.csv", "Run29.csv"]),
    ("R3_Run15_Run30_Run25_Run29", ["Run15.csv", "Run30.csv", "Run25.csv", "Run29.csv"]),
    ("R3_Run15_Run30_Run24_Run29", ["Run15.csv", "Run30.csv", "Run24.csv", "Run29.csv"]),
    ("R3_Run16_Run28_Run7_Run29", ["Run16.csv", "Run28.csv", "Run7.csv", "Run29.csv"]),
    ("R3_Run16_Run28_Run8_Run29", ["Run16.csv", "Run28.csv", "Run8.csv", "Run29.csv"]),
    ("R3_Run16_Run28_Run24_Run29", ["Run16.csv", "Run28.csv", "Run24.csv", "Run29.csv"]),
    ("R3_Run16_Run20_Run24_Run29", ["Run16.csv", "Run20.csv", "Run24.csv", "Run29.csv"]),
]
DETAIL_PATH = RESULT_DIR / "筛查明细_round3_各候选各模型.csv"
SUMMARY_PATH = RESULT_DIR / "筛查汇总_round3_候选split.csv"
HIT_PATH = RESULT_DIR / "命中候选_round3_Transformer增强第一.csv"
