...
def main() -> None:
    ...
    print(f"Round: 4 (seq=15, d=64, 2 layers, ff=128)")
    print()
    ...
    scan_df.to_csv(SCRIPT_DIR / "详细结果_R4.csv", index=False, encoding="utf-8-sig")

    print()
    print("=" * 60)
    print(f"Round 4 Complete: seq=15, d=64, 2 layers, ff=128")
    print("=" * 60)
    print(f"Mean life abs error: {float(scan_df['life_abs_error'].mean()):.0f} (baseline: 18673, best: 16319)")
