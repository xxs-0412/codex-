...
def main() -> None:
    ...
    print(f"Round: 3b (d={D_MODEL}, layers={NUM_LAYERS}, ff={DIM_FF}, seq={SEQ_LEN})")
    print()
    ...
    scan_df.to_csv(SCRIPT_DIR / "详细结果_R3b.csv", index=False, encoding="utf-8-sig")

    print()
    print("=" * 60)
    print(f"Round 3b Complete: d={D_MODEL}, layers={NUM_LAYERS}, ff={DIM_FF}")
    print("=" * 60)
    print(f"Mean life abs error: {float(scan_df['life_abs_error'].mean()):.0f} (baseline: 18673, R3: 16319)")
